...
public class search {
	...
	public static String SearchCompany(String orgMdmCode, String tokenName, String modelName, String systemCodeName) throws Exception
	{
        ...
        //设置请求头
		String mdmToken = EXUEconfig.getProperty(tokenName);
		...
		String systemCode = EXUEconfig.getProperty(systemCodeName);
		String gdCode = EXUEconfig.getProperty(modelName);
